#!/usr/bin/env python3
"""
Evaluation with MPS Completely Disabled
"""
import os

# CRITICAL: Set ALL threading/device environment variables BEFORE any imports
...
# CRITICAL: Disable MPS completely at the environment level
os.environ['PYTORCH_ENABLE_MPS_FALLBACK'] = '0'
os.environ['PYTORCH_MPS_HIGH_WATERMARK_RATIO'] = '0.0'

# Import torch and disable MPS immediately
import torch
torch.set_num_threads(1)

# Force CPU only - disable MPS backend detection
if hasattr(torch.backends, 'mps'):
    # Monkey-patch to make MPS unavailable
...
def main():
    ...
    # Load encoder once - imports happen here
    ...
    model.to(device)
    model.eval()
    print("Encoder loaded successfully on CPU!")
